function units = PCACluster2Lin(PCAEllipses, PCAPts)
% units = PCACluster2Lin(PCAEllipses, PCAPts)
%
%
% Input values:
%
...
%
% PCAPts      -- the PCA'd points to sort; it should be (2 x nWaves)
%
%
% Output values:
%
...
% for it
for u = 2:length(PCAEllipses.params)
